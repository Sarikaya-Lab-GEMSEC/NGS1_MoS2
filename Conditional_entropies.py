...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 22 18:51:41 2019

@author: siddharthrath
"""

''' Conditional probabilities and entropy of DNA and peptide Sequences
    from Next Generation sequencing and directed evolution'''
...
sns.heatmap(dna_ent,cmap='terrain_r')
plt.show()
plt.close()
sns.heatmap(pep_ent,cmap='terrain_r')
plt.show()
plt.close()
...
print('---------Calculating conditional probabilities & Entropies of all in Pan1---------')
dna_pan1_prob={}
log_dna_pan1_prob={}
pep_pan1_prob={}
log_pep_pan1_prob={}
...
for i in sets:
    key = 'set_'+str(i)
    dna_pan1_ent[key] = SeqEntropy(dna_pan1_prob[key]/dna_prob[key],log_dna_pan1_prob[key]-log_dna_prob[key])
    pep_pan1_ent[key] = SeqEntropy(pep_pan1_prob[key]/pep_prob[key],log_pep_pan1_prob[key]-log_pep_prob[key])
...
sns.heatmap(dna_pan1_ent,cmap='terrain_r')
plt.show()
plt.close()
sns.heatmap(pep_pan1_ent,cmap='terrain_r')
plt.show()
plt.close()
...
for i in sets:
    key = 'set_'+str(i)
    dna_pan2_ent[key] = SeqEntropy(dna_pan2_prob[key]/dna_prob[key],log_dna_pan2_prob[key]-log_dna_prob[key])
    pep_pan2_ent[key] = SeqEntropy(pep_pan2_prob[key]/pep_prob[key],log_pep_pan2_prob[key]-log_pep_prob[key])
...
sns.heatmap(dna_pan2_ent,cmap='terrain_r')
plt.show()
plt.close()
sns.heatmap(pep_pan2_ent,cmap='terrain_r')
plt.show()
plt.close()
...
for i in sets:
    key = 'set_'+str(i)
    dna_pan3_ent[key] = SeqEntropy(dna_pan3_prob[key]/dna_prob[key],log_dna_pan3_prob[key]-log_dna_prob[key])
    pep_pan3_ent[key] = SeqEntropy(pep_pan3_prob[key]/pep_prob[key],log_pep_pan3_prob[key]-log_pep_prob[key])
...
sns.heatmap(dna_pan3_ent,cmap='terrain_r')
plt.show()
plt.close()
sns.heatmap(pep_pan3_ent,cmap='terrain_r')
plt.show()
plt.close()
...
for i in sets:
    key = 'set_'+str(i)
    dna_elu_ent[key] = SeqEntropy(dna_elu_prob[key]/dna_prob[key],log_dna_elu_prob[key]-log_dna_prob[key])
    pep_elu_ent[key] = SeqEntropy(pep_elu_prob[key]/pep_prob[key],log_pep_elu_prob[key]-log_pep_prob[key])
...
sns.heatmap(dna_elu_ent,cmap='terrain_r')
plt.show()
plt.close()
sns.heatmap(pep_elu_ent,cmap='terrain_r')
plt.show()
plt.close()